...
Welcome to ``Blackjack`` contributor's guide.
...
If you experience bugs or general issues with ``Blackjack``, please have a look
...
You can help improve ``Blackjack`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``Blackjack`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``Blackjack``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n Blackjack python=3 six virtualenv pytest pytest-cov
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/Blackjack.git
    cd Blackjack
...
#. Install |pre-commit|_::
   ...
   ``Blackjack`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/Blackjack
.. _issue tracker: https://github.com/<USERNAME>/Blackjack/issues
.. <-- end -->
